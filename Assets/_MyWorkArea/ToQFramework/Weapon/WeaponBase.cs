...
namespace QFramework.Car
{
	...
	{
        protected ResLoader m_resLoader = ResLoader.Allocate();
        ...
        {
            this.m_weaponModel = this.GetModel<WeaponModel>();
        ...
        protected virtual void OnUpdate()
        {
            ...
            if (fireCdTimer.CoolDownOnUpdate(Time.deltaTime))//开火是否冷却完毕
            {
                WeaponExecute();
                //武器攻击时生效
                this.m_weaponModel.OnWeaponExecute.Trigger();
                ...
                if (this.currentCapacity <= 0)//空弹夹，通知换弹
                {
                    ...
                    //换弹时触发
                    this.m_weaponModel.OnWeaponReload.Trigger(); 
                }
            }
        }
