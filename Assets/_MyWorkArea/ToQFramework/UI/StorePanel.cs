...
namespace QFramework.Car
{
	...
	public partial class StorePanel : UIPanel
	{
        ...
        protected override void OnInit(IUIData uiData = null)
		{
            ...
            //渲染商品
            foreach (var item in m_itemModel.ItemData)
            {
                var grid = ResUtil.GenerateGO("ItemGrid", StoreRoot);
                grid.transform.Find("ItemImg").GetComponent<Image>().sprite = ResUtil.LoadSprite(item.ItemImg);
        ...
        {
            var grid = ResUtil.GenerateGO("InventoryItemBtn", InventoryItemParent);
            grid.GetComponent<Image>().sprite = ResUtil.LoadSprite(item.ItemImg);
            //点击后装备
        ...
        {
            var grid = ResUtil.GenerateGO("EquippedItemBtn", EquippedItemParent);
            grid.GetComponent<Image>().sprite = ResUtil.LoadSprite(item.ItemImg);
            grid.GetComponent<Button>().onClick.AddListener(() =>
            {
